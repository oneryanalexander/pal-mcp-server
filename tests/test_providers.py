...
class TestModelProviderRegistry:
    ...
    def test_get_provider_for_model(self):
        ...
        provider = ModelProviderRegistry.get_provider_for_model("gemini-3.8-flash")
...
class TestGeminiProvider:
    ...
    def test_generate_content(self, mock_client_class):
        ...
        response = provider.generate_content(prompt="Test prompt", model_name="gemini-3.8-flash", temperature=0.7)
